...
class LocationCreateViewTests(TestCase):
    ...
    def test_value_of_instance_variables_set_through_get_trailhead(self):
        ...
        view = setup_view(view, request, **kwargs)
        view.get(request, **kwargs)
        self.assertEqual(view.kwargs['location_type'], TripLocation.BEGIN)
    ...
    def test_get_initial_returns_trip_and_location_type(self):
        request = self.factory.get('/fake/')
        request.user = self.user
        view = LocationCreateView()
        kwargs={'trip_id': self.trip.id, 'location_type': 'camp'}
        ...
        self.assertIn('trip', initial)
        self.assertIn('location_type', initial)
...
class LocationEditViewTests(TestCase):
    ...
    def test_url_name_reverses_correctly(self):
        url_path = '/trips/1/edit/fake_string/2/'
        reverse_path = reverse('trips:location_edit', args=(
            1, 'fake_string', 2))
        self.assertEqual(reverse_path, url_path)
    ...
    def test_value_of_instance_variables_set_through_get_trailhead(self):
        ...
        view = setup_view(view, request, **kwargs)
        view.get(request, **kwargs)
        self.assertEqual(view.page_title, 'Edit trailhead details')
        self.assertEqual(view.submit_button_title, 'Save Trailhead')
    ...
    def test_value_of_instance_variables_set_through_get_objective(self):
        ...
        view = setup_view(view, request, **kwargs)
        view.get(request, **kwargs)
        self.assertEqual(view.page_title, 'Edit objective details')
        self.assertEqual(view.submit_button_title, 'Save Objective')
    ...
    def test_value_of_instance_variables_set_through_get_camp(self):
        ...
        view = setup_view(view, request, **kwargs)
        view.get(request, **kwargs)
        self.assertEqual(view.page_title, 'Edit camp details')
        self.assertEqual(view.submit_button_title, 'Save Camp')
...
class LocationDeleteViewTests(TestCase):
    ...
    def test_url_name_reverses_correctly(self):
        url_path = '/trips/1/delete/fake_string/2/'
        reverse_path = reverse('trips:location_delete', args=(
            1, 'fake_string', 2))
        self.assertEqual(reverse_path, url_path)
    ...
    def test_value_of_instance_variables_set_through_get_trailhead(self):
        ...
        view = setup_view(view, request, **kwargs)
        view.get(request, **kwargs)
        self.assertEqual(view.page_title, 'Delete trailhead')
        self.assertEqual(view.submit_button_title, 'Delete Trailhead')
    ...
    def test_value_of_instance_variables_set_through_get_objective(self):
        ...
        view = setup_view(view, request, **kwargs)
        view.get(request, **kwargs)
        self.assertEqual(view.page_title, 'Delete objective')
        self.assertEqual(view.submit_button_title, 'Delete Objective')
