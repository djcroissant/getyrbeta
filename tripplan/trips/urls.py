...
urlpatterns = [
    ...
    url(r'^edit/(?P<trip_id>[0-9]+)/trailhead/(?P<pk>[0-9]+)/$',
        views.TrailheadEditView.as_view(), name='trailhead_edit'),
    ...
    url(r'^delete/(?P<trip_id>[0-9]+)/trailhead/(?P<pk>[0-9]+)/$',
        views.TrailheadDeleteView.as_view(), name='trailhead_delete'),
